          ...
          <div class="is-clearfix mt-2">
            <AfterStageDropdown
              :selected-button-title="
                $t('page_pool_ranking_per_stage_dropdown')
              "
              ...
              :selected-page-title="''"
              :selected-page-name="
                'race-pool-slug-ranking-number-rankingpoints'
              "
            ...
            >
              {{ $t('page_pool_ranking_after_stage_link') }}
            </nuxt-link>
          </div>
        </div>
      </div>
...
import RankingpointsOfPool from '@/components/RankingpointsOfPool'
