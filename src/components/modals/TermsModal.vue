    ...
    <section class="modal-card-body">
      <div class="content">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Yosoku Games, Sloterkade 90-2, 1058
              HK Amsterdam.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to {{ settings.domain.title }},
              accessible from
              <a href="/">https://{{ settings.domain.name }}</a>
              and operated by Yosoku Games
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          ...
          <a href="mailto:team@yosokugames.com">team@yosokugames.com</a>
